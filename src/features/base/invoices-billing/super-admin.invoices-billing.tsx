...
const SuperAdminInvoicesBilling: React.FC = () => {
      ...
      <section className="w-full h-full bg-white">
        <div className="w-full flex items-center justify-between p-2">
          <div className="flex items-center gap-x-2">
            ...
            <CommonSelect
              value={filters?.account ?? 'shipment'}
          ...
          <div className="flex items-center gap-x-2">
            <Button variant="ghost" className="box-shadow bg-orange-400 text-white">
              Create Invoice
            </Button>
          </div>
        </div>
            ...
            {entities.length ? (
              ...
              <tr>
                <td colSpan={4} className="text-center py-4">
                  <Typography variant="h5">No invoice found.</Typography>
                </td>
              </tr>
            )}
          </tbody>
...
export default SuperAdminInvoicesBilling;
