...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 gap-x-1 w-full items-center justify-between rounded-lg border border-input-border bg-white px-4 py-2 text-xs focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 data-[placeholder]:text-input-placeholder',
      className,
    )}
    {...props}
  >
